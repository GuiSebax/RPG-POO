...
public class TelaCriacaoPersonagem extends javax.swing.JFrame {
    ...
    int vigorAnterior = 1;
    int manaAnterior = 1;
    int estaminaAnterior = 1;
    int forcaAnterior = 1;
    int destrezaAnterior = 1;
    int inteligenciaAnterior = 1;
    int feAnterior = 1;
    int sorteAnterior = 1;
    
    public TelaCriacaoPersonagem(Usuario us, String gender, String cls) {
        user = us;
        genero = gender;
        classe = cls;
        initComponents();
        ...
        CBequipamento1.removeAllItems();
        CBequipamento2.removeAllItems();
        CBacessorio.removeAllItems();
        CBRaca.removeAllItems();
        
        SpinnerVigor.setValue(1);
        SpinnerMana.setValue(1);
        SpinnerEstamina.setValue(1);
        SpinnerForca.setValue(1);
        SpinnerDestreza.setValue(1);
        SpinnerInteligencia.setValue(1);
        SpinnerFe.setValue(1);
        SpinnerSorte.setValue(1);
        
        LBPontosRestantes.setText("55");
    ...
    public void criarPersonagem()
    {
        ...
        persondao.salvarPersonagem(person);
    ...
    private void initComponents() {
        ...
        CBequipamento1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        CBequipamento2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        CBacessorio.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addComponent(LBPontosRestantes, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(36, 36, 36)
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
    ...
    private void BtnVoltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnVoltarActionPerformed
        TelaDefinirClasse telaDefinir = new TelaDefinirClasse(user);
        telaDefinir.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCriacaoPersonagem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
